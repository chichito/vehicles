    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create(UserViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    imageId = await _blobHelper.UploadImageAsync(model.ImageFile, "users");
                }
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            _blobHelper.DeleteImageAsync(user.ImageId.ToString(), "users");
        ...
        public async Task<IActionResult> AddVehicle(VehicleViewModel vehicleViewModel)
        {
            ...
            {
                imageId = await _blobHelper.UploadImageAsync(vehicleViewModel.ImageFile, "vehicles");
            }
            ...
            catch (DbUpdateException dbUpdateException)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Ya existe con esa placa.");
                }
                else
                {
        ...
        public async Task<IActionResult> DeleteImageVehicle(int? id)
        {
            ...
            _blobHelper.DeleteImageAsync(vehiclePhoto.ImageId.ToString(), "vehicles");
        ...
        public async Task<IActionResult> AddVehicleImage(VehiclePhotoViewModel model)
        {
            if (ModelState.IsValid)
            {
                Guid ImageId = await _blobHelper.UploadImageAsync(model.ImageFile, "vehicles");
                Vehicle vehicle = await _context.Vehicles
