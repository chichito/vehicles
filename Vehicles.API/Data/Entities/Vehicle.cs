...
namespace Vehicles.API.Data.Entities
{
    public class Vehicle
    {
        ...
        [Display(Name = "Tipo de veh{iculo")]
        ...
        [Range(1900, 3000, ErrorMessage = "El valor del módelo no válido.")]
        public int Model { get; set; }

        [Display(Name = "Placa")]
        [RegularExpression(@"[a-zA-Z]{3}[0-9]{4}",ErrorMessage ="Formato de placa incorrecto")]
        [Required(ErrorMessage = "El campo {0} es obligatorio.")]
